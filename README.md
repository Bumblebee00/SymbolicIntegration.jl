...
## Mild
Serious problems are problems that impact the correct functioning of the rule based symbolic integrator and are medium difficulty to fix. Here are the ones i encountred so far:
- some rules have the integral inside a function call (like substitute) with integral to be executed before the function call, for example rule 1_1_1_2_23.
